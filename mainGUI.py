...
import sys, os
sys.path.append(os.path.dirname(__file__))  # make sure current folder is searched first
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title("Deep Bone Fracture Detection")
        ...
        self.head_label = ctk.CTkLabel(master=self.head_frame, text="Deep Bone Fracture Detection",
